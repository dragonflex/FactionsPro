...
# TODO list:
# combine '/f ourmembers' and '/f membersof' commands into '/f members [faction]'
# combine '/f ourofficers' and '/f officersof' commands into '/f officers [faction]'
# combine '/f ourleader' and '/f leaderof' commands into '/f leader [faction]'
#
...
class FactionMain extends PluginBase implements Listener {
	...
	/** @var string[] $wars */
	public $wars = [];
	/** @var string[] $war_players */
	public $war_players = [];
	/** @var null|\awzaw\antispampro\AntiSpamPro */
	public $antispam;
	...
	public function onEnable() {
		...
		if ($this->antispam instanceof \awzaw\antispampro\AntiSpamPro) {
	...
	public function onCommand(CommandSender $sender, Command $command, $label, array $args) {
		$this->fCommand->onCommand($sender, $command, $args);
	}
